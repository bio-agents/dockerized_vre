define([
       ...
       function( declare, dom, Agentbar, Button, Util, has ) {
...
return declare(null,
{
    ...
    renderHTML: function( region, seq, parent ) {
        ...
        if( this.canSaveFiles ) {
            var agentbar = new Agentbar().placeAt( container );
            var thisB = this;
            
	    // hook point
	if (typeof thisB.addButtons === 'function')        
            thisB.addButtons(region, seq, agentbar);
                              
            agentbar.addChild( new Button(
