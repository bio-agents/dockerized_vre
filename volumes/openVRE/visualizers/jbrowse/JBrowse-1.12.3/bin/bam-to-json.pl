...
foreach my $seqInfo (@refSeqs) {
    ...
    # samagents returns plausible-looking garbage in this case.
    # perhaps coincidentally, samagents has no tests.  Could the
    # bugginess and the lack of tests be ... *related* to each other
    # in some way?  I would probably try to fix this bug in samagents
