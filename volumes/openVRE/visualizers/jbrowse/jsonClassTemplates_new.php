...
class BW_ND extends Base {
        ...
        public function __construct($label,$path,$file){
                parent::__construct("BigWig",$label,$path,$file);
                $this->metadata = array("category" => "Your Data / Projects / $path", "description" => "The bigWig file contains the -log10 of the p-value of how significant is the difference between both experiments (<a href=\"https://vre.multiscalegenomics.eu/agents/nucldynwf/help/method.php#nd\" target='_blank'>see methods</a>).");
        }
