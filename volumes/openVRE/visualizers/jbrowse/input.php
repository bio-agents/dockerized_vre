...
// get agent details
$agentId = "jbrowse";
$agent   = getVisualizer_fromId($agentId,1);
?>
  ...
  <div class="page-wrapper">
	...
	?>
      ...
      <div class="row">
            ...
            <div class="mt-element-step">
              <div class="row step-line">
                <div class="col-md-6 mt-step-col first active">
                  ...
                  <div class="mt-step-title uppercase font-grey-cascade">Select agent
                  </div>
                </div>
        ...
        <form action="javascript:;" class="horizontal-form" id="agent-input-form">
...
echo getVisualizerTableList($agent['accepted_file_types'], "jbrowse");
?>
            </div>
          </div>
          <div class="alert alert-warning warn-agent display-hide">
            <strong>Warning!
