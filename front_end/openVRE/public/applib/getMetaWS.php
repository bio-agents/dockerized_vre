...
<div id="meta-log">
		...
		<?php }else{ ?>
			<a href="javascript:;" class="btn grey agenttips" data-container="body" data-html="true" data-placement="bottom" data-original-title="<p align='left' style='margin:0'>File not available</p>"><i class="fa fa-exclamation-triangle"></i> VIEW LOG FILE </a>
		<?php } 
        ...
        if(($_SESSION['User']['Type'] == 0) || ($_SESSION['User']['Type'] == 1)) { ?>
			...
			<?php }else{ ?>
			<a href="javascript:;" class="btn grey agenttips" data-container="body" data-html="true" data-placement="bottom" data-original-title="<p align='left' style='margin:0'>File not available</p>"><i class="fa fa-exclamation-triangle"></i> VIEW SUBMIT FILE </a>
			<?php } ?>
			...
			<?php }else{ ?>
			<a href="javascript:;" class="btn grey agenttips" data-container="body" data-html="true" data-placement="bottom" data-original-title="<p align='left' style='margin:0'>File not available</p>"><i class="fa fa-exclamation-triangle"></i> VIEW CONFIG FILE </a>
			<?php } ?>
			...
			<?php }else{ ?>
			<a href="javascript:;" class="btn grey agenttips" data-container="body" data-html="true" data-placement="bottom" data-original-title="<p align='left' style='margin:0'>File not available</p>"><i class="fa fa-exclamation-triangle"></i> VIEW META FILE </a>
			<?php } ?>
			...
			<?php }else{ ?>
			<a href="javascript:;" class="btn grey agenttips" data-container="body" data-html="true" data-placement="bottom" data-original-title="<p align='left' style='margin:0'>File not available</p>"><i class="fa fa-exclamation-triangle"></i> VIEW RESULTS FILE </a>
			<?php }
        } ?>
</div>
