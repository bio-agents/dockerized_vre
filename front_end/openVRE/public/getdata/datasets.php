...
//	$ds_list =  getDatasets();
    ...
    while ($i < 1000320) {
      ...
      'catalogue_url' => "https://catalogue.dataagents4heart.eu/dataset/?".$GLOBALS['AppPrefix'].$i
      ];
      ...
      $n++;
		...
		foreach ($datasets as $obj) {
             ...
             <tr>
			  ...
			  <form action="agents/dataMaterialize/input.php" method="post">
  				...
  				<button type="submit" class="btn green dropdown-toggle" value="submit">
				    <i class="fa fa-download agenttips font-white" data-original-title="Materialize datasets"></i>
	  			</button>
		    </form>
        </td>
                </tr>
