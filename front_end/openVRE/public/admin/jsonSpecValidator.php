...
<!-- BEGIN CONTENT -->
    ...
    <!-- BEGIN CONTENT BODY -->
        ...
        <!-- BEGIN PAGE BAR -->
            <div class="page-bar">
                <ul class="page-breadcrumb">
					...
					<li><a href="admin/myNewAgents.php">My new agents</a><i class="fa fa-circle"></i></li>
                    <li><span>Agent specification</span></li>
                </ul>
            </div>
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title">Agent specification</h1>
        <!-- END PAGE TITLE-->
		<!-- END PAGE HEADER-->
		...
		<form name="new-agent" id="new-agent" action="applib/updateAgentDevSpec.php" method="post" >
            <div class="row">
                <div class="col-md-12">
					<p style="margin-top:0;">Paste or write your JSON code in the text area below. Once the JSON is correct,
you can validate it against our <a href="https://raw.githubusercontent.com/Multiscale-Genomics/VRE_agent_jsons/dev/agent_specification/agent_schema.json" target="_blank">JSON Schema</a>. Click the buttons below for further information:</p>
			    	<p>
                    ...
                    <div class="portlet light portlet-fit bordered">
						<div class="portlet-body form" id="portlet-json">
							...
							<textarea id="code_editor" name="json_agent"  placeholder="Please, paste or write your JSON code here..."><?php echo json_encode($agentDevJSON["step3"]["agent_spec"], JSON_PRETTY_PRINT); ?></textarea>
						</div>
                    </div>
